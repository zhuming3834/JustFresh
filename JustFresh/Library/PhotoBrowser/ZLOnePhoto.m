...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary<NSString *,id> *)info
{
    [_vc dismissViewControllerAnimated:YES completion:^{
        ...
        if (_photoCutType == PhotoCutType_YES) {
            VPImageCropperViewController *imgEditorVC = [[VPImageCropperViewController alloc] initWithImage:portraitImg cropFrame:CGRectMake(0, CGRectGetMidY(_vc.view.frame)-kScreenWidth*1/2.0-32, kScreenWidth, kScreenWidth*1) limitScaleRatio:3.0];
